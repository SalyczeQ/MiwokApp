...
/**
 * Created by salay on 30.06.2016.
 */
public class WordFragmentPagerAdapater extends FragmentPagerAdapter{
    Context context;
    public WordFragmentPagerAdapater(Context context, FragmentManager fm) {
        super(fm);
